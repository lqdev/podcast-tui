...
impl HelpBuffer {
    ...
    fn default_help_content() -> Vec<String> {
        vec![
            ...
            "It uses Emacs-style keybindings for navigation and commands.".to_string(),
            "".to_string(),
            "BASIC NAVIGATION:".to_string(),
            "  C-n, ↓        Move down".to_string(),
            "  C-p, ↑        Move up".to_string(),
            "  C-f, →        Move right".to_string(),
            "  C-b, ←        Move left".to_string(),
            "  C-v, PgDn     Page down".to_string(),
            "  M-v, PgUp     Page up".to_string(),
            "  C-a, Home     Move to beginning".to_string(),
            "  C-e, End      Move to end".to_string(),
            "".to_string(),
            "BUFFER MANAGEMENT:".to_string(),
            "  C-x b         Switch buffer".to_string(),
            "  C-Tab         Next buffer".to_string(),
            "  C-S-Tab       Previous buffer".to_string(),
            "".to_string(),
            "WINDOW MANAGEMENT:".to_string(),
            "  C-x 1         One window (close others)".to_string(),
            "  C-x 2         Split window horizontally".to_string(),
            "  C-x 3         Split window vertically".to_string(),
            "  C-x o         Other window (switch)".to_string(),
            "  C-x 0         Close current window".to_string(),
            "".to_string(),
            "APPLICATION COMMANDS:".to_string(),
            "  C-x C-c       Quit application".to_string(),
            "  C-g           Cancel current command".to_string(),
            "  C-l, F5       Refresh current buffer".to_string(),
            "  M-x           Execute command".to_string(),
            "  C-h, F1       Show help".to_string(),
            "".to_string(),
            "CONTENT INTERACTION:".to_string(),
            "  Enter, Space  Select/activate item".to_string(),
            "  Tab           Expand item".to_string(),
            "  S-Tab         Collapse item".to_string(),
            "".to_string(),
            "Note: C- means Control key, M- means Alt key".to_string(),
        ]
    }
