...
- **Graceful invalid notation handling** — unrecognised key notation strings in config are silently skipped; the action retains its default binding rather than crashing
